...
-->
    <div class="form-group text-center">
        <button type="button" id="NuevoUsuario" data-bs-toggle="modal" data-bs-target="#userModal" class="mt-3 btn btn-outline-primary btn-lg font-weight-bold"> 
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">   
                <div class="modal-header alert-info" >
                    <h5 class="mx-auto display-5 font-weight-bold modal-title" id="modalTitulo">
