...
<?php include('../Modales/NewProveedorModal.php')?>
<?php include('../Modales/EditProveedorModal.php')?>
<?php include('../Modales/DeleteProveedorModal.php')?>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="form-group text-right"> <!--Boton para modal Empleado -->
                            <button type="button" id="NuevoEmpleado" data-bs-toggle="modal" data-bs-target="#addProveedor" class="mb-2 btn btn-outline-primary btn-sm font-weight-bold  "> 
                                    ...
                                    <tbody>
                                        <?php while($row= $resultado->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td> <!-- Btn Para editar -->
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#editProveedor" 
                                                ...
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#deleteProveedor" 
