<!--Modal de registro -->
<div id="addProveedor" class="modal fade" tabindex="-1" aria-hidden="true" aria-labelledby="modalTitulo" >
        <div class="modal-dialog w-75 modal-center">
            <div class="modal-content">   
                ...
                <div class="modal-boddy">
                    ...
                    <form class=" needs-validation "  novalidate method="POST" action="../scrips/AddProvedor.php"> <!-- Formulario -->
                        <div class="form-group w-75 mx-auto">
                            <!-- No se muestra el imput, solo es para recibir y mandar el id del usuario-->
                        <input type="hidden" id="idProveedorM" name="idProveedor" value="1">
                        </div>
                        

                        <div class="form-group w-75 mx-auto"> <!-- Nombre-->
                            <label for="Nombre" class="label font-weight-bold">Nombre:</label>
                            <input type="text" class="form-control" id="NomProvM" name="Nombre" placeholder="Sony" autofocus required>
                        ...
                        <div class="form-group w-75 mx-auto"> <!-- Apellidos -->
                            ...
                            <input type="text" class="form-control" id="ContactoM" name="Contacto" placeholder="Juan Hernández" autofocus required>
                            <div class="valid-feedback">Verificado</div>
