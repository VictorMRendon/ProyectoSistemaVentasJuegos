<!--Modal de registro -->
<div id="addProducto" class="modal fade" tabindex="-1" aria-hidden="true" aria-labelledby="modalTitulo" >
        <div class="modal-dialog w-75 modal-center">
            <div class="modal-content">   
                ...
                <div class="modal-boddy">                    
                    <p>
                    <form class=" needs-validation "  novalidate method="POST" action="../scrips/AddProducto.php"> <!-- Formulario -->
                        ...
                        <div class="form-group w-50 mx-auto"> <!-- Codigo-->
                            ...
                            <input type="text" class="form-control" id="CodigoM" name="Codigo" placeholder="0001" autofocus required>
                        ...
                        <div class="form-group w-50 mx-auto"> <!-- Fecha Publicacion -->
                            ...
                            <input type="date" class="form-control" id="FechaPubM" name="FechaPublic">
                            <div class="valid-feedback">Verificado</div>
                        ...
                        <div class="form-group w-75 mx-auto"> <!-- Desarrolladora -->
                            ...
                            <input type="text" class="form-control" id="DesarM" name="Desarrolladora" placeholder="Sony"  required>
                            <div class="valid-feedback">Verificado</div>
                        ...
                        <div class="form-group w-25 mx-auto"> <!-- Stock -->
                            ...
                            <input type="number" class="form-control" id="StockM" name="Stock" placeholder="20" min="1" max="99" required>
                            <div class="valid-feedback">Verificado</div>
                        ...
                        <div class="w-50 mx-auto"> <!-- Presentacion -->
                            ...
                            <select name="Pres" id="PresM" class="custom-select form-select-lg mb-4" required>
                        ...
                        <div class="w-50 mx-auto"> <!-- Plataforma -->
                            ...
                            <select name="Plataforma" id="PlataformaM" class="custom-select form-select-lg mb-4" required>
                                <option selected disabled>Escoja una opción...</option>
