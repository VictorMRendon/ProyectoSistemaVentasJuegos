        ...
        <div class="modal-dialog w-75 modal-center">
            <div class="modal-content">   
                ...
                <div class="modal-boddy">
                    <p>
                    <form class=" needs-validation"  novalidate method="POST" action="../scrips/EditUsuario.php"> <!-- Formulario -->

                        <!-- No se muestra el imput, solo es para recibir y mandar el id del usuario-->
                        <input type="hidden" id="idUsuarioM" name="idUsuario" >

                        <div class="form-group w-50 mx-auto"> <!-- Nombre-->
                            <label for="Nombre" class="label font-weight-bold">Nombre de usuario:</label>
                            <input type="text" class="form-control" id="NombreM" name="Nombre" placeholder="Nombre(s) Apellidos" autofocus required>
                        ...
                        <div class="form-group w-50 mx-auto"> <!-- Email -->
                            ...
                            <input type="email" class="form-control" id="EmailM" name="Email" placeholder="usuario@tiendavideo.com" required>
                            <div class="valid-feedback">Verificado</div>
                        ...
                        <div class="form-group w-25 mx-auto"> <!-- Pasword -->
                            ...
                            <input type="password" class="form-control" id="PaswordM" name="Pasword" placeholder="Ej3mpl01234" required>
                            <div class="valid-feedback">Verificado</div>
                        ...
                        <button class=" btn btn-outline-success  font-weight-bold mt-2" type="submit" id="SaveCambio" name="SaveCambios" >Guardar Cambios</button>
                        </div>
