<!--Modal de  eliminar -->
<div id="eliminarUsuario" class="modal fade" tabindex="-1" aria-hidden="true" aria-labelledby="modalTitulo" >
        <div class="modal-dialog w-75 modal-center">
            <div class="modal-content">   
                ...
                <div class="modal-boddy">
                    ...
                    <p>
                    <form class=" needs-validation"  novalidate method="POST" action="../scrips/DeleteUsuario.php"> <!-- Formulario -->
