<!--Modal de  eliminar -->
<div id="deleteEmpleado" class="modal fade" tabindex="-1" aria-hidden="true" aria-labelledby="modalTitulo" >
        <div class="modal-dialog w-75 modal-center">
            <div class="modal-content">   
                ...
                <div class="modal-boddy">
                    ...
                    <p>
                    <form class=" needs-validation"  novalidate method="POST" action="../scrips/DeleteEmpleado.php"> <!-- Formulario -->

                        <!-- No se muestra el imput, solo es para recibir y mandar el id del usuario-->
                        <input type="hidden" id="idEmpleadoMD" name="idEmpleadoD" >
