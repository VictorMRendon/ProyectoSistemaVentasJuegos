...
<html lang="es">
                    ...
                    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                        <div class="sb-sidenav-menu">
                            <div class="nav">
                                ...
                                <div> <!-- Seccion de paginas-->
                                    ...
                                    <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">                                            
                                                ...
                                                <a class="nav-link" href="../MenuPrincipal/MainProveedores.php">Poveedores</a>
                                ...
                                <a class="nav-link" href="../MenuPrincipal/MainInventario.php">
                                    <div class="sb-nav-link-icon"></div>
  ...
  <path fill-rule="evenodd" d="M0 0h1v15h15v1H0V0Zm14.817 3.113a.5.5 0 0 1 .07.704l-4.5 5.5a.5.5 0 0 1-.74.037L7.06 6.767l-3.656 5.027a.5.5 0 0 1-.808-.588l4-5.5a.5.5 0 0 1 .758-.06l2.609 2.61 4.15-5.073a.5.5 0 0 1 .704-.07Z"/>
                        ...
                        <div class="sb-sidenav-footer fixed-bottom">
                            <div class="small">Empleado activo actualmente:</div>
